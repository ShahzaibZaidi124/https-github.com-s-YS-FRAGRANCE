  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wider uppercase",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent text-foreground hover:bg-secondary hover:border-muted-foreground rounded-none",
        ...
        gold: "bg-gradient-to-r from-gold-dark via-gold to-gold-light text-background hover:shadow-lg hover:shadow-gold/20 rounded-none border-0",
        goldOutline: "border border-gold bg-transparent text-gold hover:bg-gold hover:text-background rounded-none transition-all duration-300",
      },
      size: {
