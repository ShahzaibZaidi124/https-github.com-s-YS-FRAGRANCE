    ...
    <footer className="bg-card border-t border-gold/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
            ...
            <div className="w-40 h-40 bg-white p-2 rounded-lg overflow-hidden flex items-center justify-center">
              <img 
                ...
                onError={(e) => {
                  ...
                  target.src = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://wa.me/923461034768";
                }}
              />
            </div>
            <div className="text-center">
              <p className="text-gold font-display text-sm tracking-widest uppercase">WhatsApp Channel</p>
              <p className="text-muted-foreground font-body text-xs mt-1">Scan to join our channel</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-xl mx-auto mb-16">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 p-6 rounded-xl bg-gradient-to-r from-gold/10 to-gold/5 border border-gold/20 backdrop-blur-sm">
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#25D366] rounded-full animate-ping"></div>
            </div>
        ...
        <div className="border-t border-gold/20 pt-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground font-body text-xs opacity-50">
              made by shahzaib
            </p>
          </div>
        </div>
